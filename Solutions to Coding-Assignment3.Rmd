...
There are almost twice as many sophomores (2nd year students) as other levels of students. The information from sophomores is therefore more heavily weighted in the analysis. To the extent that sophomore's habits differ from other students, the results may not generalize well to the full population at the school. 
...
The mean GPA is pretty good - 3.24. 50% of students have a GPA between 3 and 3.5. The minimum GPA is 2.0 and the maximum is 4.0. 
...
```{r createLowGPA}
# Create a boolean of whether GPA is less than 3
GPA_lt3 <- SleepStudy$GPA < 3

# Turn this into a 0/1 dummy 
GPA_lt3_int <- 1*GPA_lt3

# Add a variable called LowGPA to SleepStudy which is equal to the 0/1 dummy
SleepStudy$LowGPA <- GPA_lt3_int

# Check that LowGPA is 1 when GPA is less than 3 and 0 otherwise
...
There is very little difference in GPA when comparing students with insufficient sleep to those with sufficient sleep. Students with insufficient sleep have a slightly higher GPA - 3.28 compared to 3.21 for students with sufficient sleep. 
...
Do students with higher reported anxiety have lower sleep quality? 

Who are more likely to pull an all-nigher? Students with a low GPA or students with a high GPA? 
