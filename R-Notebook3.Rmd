...
For more details on `dplyr` functions, with explanations and examples
- https://dplyr.tidyverse.org/

Note this page Finally, compares `dplyr` functions to their base R equivalents.
- https://dplyr.tidyverse.org/articles/base.html

Helpful prompt recipe for `dplyr`: 
